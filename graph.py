...
def plot_candlestick_graph(currency, dates, openings, closings, highs, lows, width ):
    ...
    candlestick_ohlc(ax, ohlc_data.values, width=width, colorup='green', colordown='red', alpha=0.8)
